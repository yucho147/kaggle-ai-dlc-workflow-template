...
4. `docs/01_agent_execution_guide.md`
5. `aidlc-docs/`
...
AGENTS.md、docs/00_project_concept.md、docs/02_quickstart.md、aidlc-docs/ を読み、現在のワークフロー構成を理解してください。
...
```bash
copilot -p "AGENTS.md、docs/00_project_concept.md、docs/02_quickstart.md、aidlc-docs/ を読み、この workflow template の現在状態と次に確認すべきことを整理してください。"
```
