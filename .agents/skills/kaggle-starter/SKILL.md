...
3. Kaggle CLI の利用可否を確認する。
   ...
   - `uv run kaggle --help`
4. コンペ情報を確認する。
   - `uv run kaggle competitions files -c <competition>`
...
10. 実装前に `aidlc-docs/construction/implementation-questionnaire.md` を埋める。
...
11. `aidlc-docs/construction/architecture.md` と `code-generation-plan.md` に疎結合な構成案を作る。
12. 判断、仮定、外部情報源を `aidlc-docs/audit.md` に記録する。
